  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="mx-auto max-w-7xl px-6 py-20">
        <p className="text-amber-400 uppercase tracking-[0.4em] text-sm">Toulouse Tarn Transfert</p>
        ...
        <p className="mt-6 text-slate-300 text-lg leading-8 max-w-4xl">
          ...
          simple, paiement sécurisé et chauffeur professionnel.
        </p>
      </section>

      <section className="mx-auto max-w-7xl px-6 pb-20 grid lg:grid-cols-2 gap-8">
        ...
        <div className="rounded-3xl border border-amber-500/30 p-8 bg-zinc-900">
          <h2 className="text-2xl font-bold text-amber-400">Gare Toulouse-Matabiau</h2>
          <p className="mt-5 text-slate-300">Prise en charge directement à la gare avec accueil personnalisé.</p>
        </div>
        ...
        <div className="rounded-3xl border border-amber-500/30 p-8 bg-zinc-900">
          ...
          <p className="mt-5 text-slate-300">Accueil en français et en anglais pour les touristes et les clients internationaux.</p>
        </div>

        <div className="rounded-3xl border border-amber-500/30 p-8 bg-zinc-900">
          <h2 className="text-2xl font-bold text-amber-400">Paiement sécurisé</h2>
          <p className="mt-5 text-slate-300">Paiement CB sécurisé en ligne ou directement à bord.</p>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-6 pb-20">
        <h2 className="text-4xl font-bold text-amber-400">Pourquoi choisir Toulouse Tarn Transfert ?</h2>
        <ul className="mt-10 space-y-5 text-lg text-slate-300">
          ...
          <li>✓ Véhicule premium climatisé</li>
          <li>✓ Eau minérale offerte</li>
          <li>✓ Chargeurs USB à disposition</li>
          <li>✓ Accueil avec pancarte</li>
          <li>✓ Suivi des vols et trains</li>
          <li>✓ Paiement CB sécurisé</li>
          <li>✓ Disponible sur réservation 7j/7</li>
        </ul>
      </section>

      <section className="mx-auto max-w-7xl px-6 pb-24">
        <h2 className="text-4xl font-bold text-amber-400">Zones desservies</h2>
        <p className="mt-8 text-lg text-slate-300 leading-8">
          Toulouse • Aéroport Toulouse-Blagnac • Gare Matabiau • Castres • Albi • Lavaur • Revel • Mazamet • Tarn •
          Haute-Garonne.
        </p>
      </section>
    </main>
