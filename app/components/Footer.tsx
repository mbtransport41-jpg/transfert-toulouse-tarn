...
export default function Footer() {return ( <footer className="bg-black border-t border-amber-500/20 text-white">
...
Toulouse Tarn Transfert est votre chauffeur privé premium entre Toulouse, Castres, Albi, Lavaur, Revel, Mazamet,              l'aéroport Toulouse-Blagnac, la gare Matabiau              et toute l'Occitanie.
</p>
</div>
{/* Liens */}
<div>
...
<ul className="mt-5 space-y-3">
<li><Link href="/transferts/castres">Castres</Link></li>
<li><Link href="/transferts/albi">Albi</Link></li>
<li><Link href="/transferts/mazamet">Mazamet</Link></li>
<li><Link href="/transferts/lavaur">Lavaur</Link></li>
<li><Link href="/transferts/revel">Revel</Link></li>
</ul>
</div>
{/* Informations */}
<div>
