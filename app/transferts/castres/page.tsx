...
const destination = destinations.castres;

export const metadata: Metadata = {
  title: 'Transfert Toulouse → Castres | Chauffeur privé TTT',
  description:
    'Service de chauffeur privé de luxe entre Toulouse (aéroport, gare) et Castres. Tarifs fixes, véhicule haut de gamme, disponibilité 24h/24.',
  keywords: 'transfert Toulouse Castres, chauffeur privé, VTC, taxi, aéroport',
  openGraph: {
    title: 'Transfert Toulouse → Castres | TTT',
    description: 'Chauffeur privé de luxe avec tarifs fixes et service premium',
    type: 'website',
    url: 'https://ttt-toulouse.fr/transferts/castres',
    images: [
      {
        url: destination.imagePath,
        width: 1200,
        height: 630,
        alt: 'Transfert Toulouse Castres',
      },
    ],
  },
};

export default function CastresPage() {
  return (
    <>
      <Header />
