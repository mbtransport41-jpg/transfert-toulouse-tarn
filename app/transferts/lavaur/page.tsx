...
const destination = destinations.lavaur;

export const metadata: Metadata = {
  title: 'Transfert Toulouse → Lavaur | Chauffeur privé TTT',
  description:
    'Service de chauffeur privé de luxe entre Toulouse (aéroport, gare) et Lavaur. Tarifs fixes, véhicule haut de gamme, disponibilité 24h/24.',
  keywords: 'transfert Toulouse Lavaur, chauffeur privé, VTC, taxi, aéroport',
  openGraph: {
    title: 'Transfert Toulouse → Lavaur | TTT',
    description: 'Chauffeur privé de luxe avec tarifs fixes et service premium',
    type: 'website',
    url: 'https://ttt-toulouse.fr/transferts/lavaur',
    images: [
      {
        url: destination.imagePath,
        width: 1200,
        height: 630,
        alt: 'Transfert Toulouse Lavaur',
      },
    ],
  },
};

export default function LavaurPage() {
  return (
